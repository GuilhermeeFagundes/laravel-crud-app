...
Route::middleware(['autenticacao'])->group(function () {
    ...
    Route::get("/usuario-delete/{id}", [UsuariosController::class, 'usuarioDelete'])
        ->name("usuario-delete");


    Route::get("/usuario-delete-submit/{id}", [UsuariosController::class, 'usuarioDeleteSubmit'])
        ->name("usuario-delete-submit");
